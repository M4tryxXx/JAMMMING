...
const redirectUrl = "https://m4tryxxx.github.io/jammming/callback"; // your redirect URL - must be localhost URL and/or HTTPS
...
let personalTracksObj = await getUserTracks();
